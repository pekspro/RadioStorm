...
internal sealed class SampleData
{
    ...
    internal static Download DownloadSample(int sampleType = 0)
    {
        if (sampleType % 4 == 0)
        {
            return new Download("49771.mp3", 4131, 49771, true, null, null)
            {
        ...
        {
            return new Download("49265.mp3", 4131, 49265, false, null, null)
            {
                BytesToDownload = 5 * 1024 * 1024,
        ...
        {
            return new Download("50012.mp3", 4131, 50012, false, null, null)
            {
                BytesToDownload = 5 * 1024 * 1024,
                BytesDownloaded = 7 * 1024 * 1024 * 7 / 3,
